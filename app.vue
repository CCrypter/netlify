  ...
  <div class="min-h-screen bg-gray-900 flex items-center justify-center">
    <div class="bg-gradient-to-r from-purple-500 to-teal-400 p-1 rounded-lg">
      <div class="bg-gray-900 rounded-lg p-10">
        ...
        <input class="shadow appearance-none border rounded w-full py-2 px-3 mb-5 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" min="0" max="100" v-model="rating" type="number" @input="filterInput" placeholder="Рейтинг">
        <input class="shadow appearance-none border rounded w-full py-2 px-3 mb-5 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" min="0" max="100" v-model="exam" type="number" @input="filterInput" placeholder="Экзамен">
        ...
        <input class="shadow appearance-none border rounded w-full py-2 px-3 mb-5 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" min="0" max="100" v-model="rating1" type="number" @input="filterInput" placeholder="Экзамен">
        <div class ="flex items-center justify-center">
